...
gestures_file = 'C:/deva/Miniproject/automation-using-hand-gestures-master/preprocessing/gestures.txt'
all_dataset_dirs_file = 'C:/deva/Miniproject/automation-using-hand-gestures-master/preprocessing/all_dataset_dirs.txt'
